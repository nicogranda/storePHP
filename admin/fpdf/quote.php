...
$pdf->SetFont('Arial', '', 12); // Fuente en negrita
$pdf->SetXY(145, $lineY); // Establecer la posición horizontal a la derecha de la página
$pdf->Cell(0, 10, utf8_decode('Métodos de pago'), 0, 1, 'L'); // Escribir el texto a la derecha

// Imagen del método de pago (Bizum)
$pdf->Image('https://ikusa.net/images/banks/zelle.png', 145, $lineY + 10, 20); // Posición debajo del texto
