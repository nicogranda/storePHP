...
<section class="table-container" style="margin:0 auto;">
     <table>
        <tr>
    ...
    <table>        
        <tr>
            <th style="background-color:orangered; color:white; width:10%;">Goods/Service</th>
            <th style="background-color:orangered; color:white; width:10%;">Qty</th>
            <th style="background-color:orangered; color:white; width:10%;">Unit Value (€)</th>
            <th style="background-color:orangered; color:white; width:15%;">Unit</th>
            <th style="background-color:orangered; color:white; width:10%;">Discount</th>
            <th style="background-color:orangered; color:white; width:10%;">VAT Rate</th>
            <th style="background-color:orangered; color:white; width:15%;">Total (€)</th>
...
<input type="hidden" name="operation_id"  value="<?php echo  $operation['id'];?>" id="operation_id" >
    ...
    <section class="events">   
        ...
        include '../../app/views/components/payment_modal.php'; 
        ?>
