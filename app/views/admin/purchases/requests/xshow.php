...
<section class="table-container">
    ...
    <tr>        
        <th colspan='8' style="text-align:left; border: none; font-weight:400;">
            <p style='font-weight:800;'><?php echo $operation['client_name'];?></p>
            <p style='color:gray;'><?php echo $operation['client_email'];?></p>
...
?>
    <tr>
        ...
        <td class='item'><input type="text" name="unit_value[<?php echo $operation_detail['id']; ?>]" value="<?php echo number_format($operation_detail['unit_value'], 2); ?>"  style='text-align:right;'></td>

        <td><?php echo $operation_detail['unit'];?></td>
        <td class='item'><input type="text" name="discount[<?php echo $operation_detail['id']; ?>]" value="<?php echo number_format($operation_detail['discount'], 2); ?>"  style='text-align:right;'></td>
        <td class='item'><input type="text" name="vat_rate[<?php echo $operation_detail['id']; ?>]" value="<?php echo number_format($operation_detail['vat_rate'], 2); ?>"  style='text-align:right;'></td> 
...
?>
        ...
        <td><input type="checkbox" name="del[]" id="del<?php echo $operation_detail['id'];?>" value="<?php echo $operation_detail['id'];?>"></td>
        <input type="hidden" name="item[]"  value="<?php echo $operation_detail['id']; ?>"> 
    </tr>
    <tr>
        <td colspan="8" class='item'><input type="text" name="note[<?php echo $operation_detail['id']; ?>]" value="<?php echo $operation_detail['note'] ?>"  style='text-align:left;'></td>
    </tr>
<?php
}
?>
...
<input type="hidden" name="operation_id"  value="<?php echo  $operation['id'];?>" id="operation_id" >
    ...
    <section class="events">   
        ...
        <a href="index.php?page=RFQ_details&action=create&id=<?php echo $operation['id']; ?>">+</a>
        <a href="index.php?page=RFQ_details&action=delete&id=<?php echo $operation_detail['id']; ?>">-</a>
        <input type="button" name="print" value="Print" onclick="downloadPDF()">
        <a href="index.php?page=RFQ&action=mail&id=<?php echo $operation['id']; ?>">Mail</a>
        <a href="">Pay</a>
        <a href="index.php?page=order&action=create&operation=<?php echo $operation['id'];?>">Order</a>
        <a href="index.php?page=RFQ&action=index"> Otro</a>
    </section>   
...
function downloadPDF() {
    ...
    var url = 'https://ikusa.net/admin/index.php?page=RFQ&action=print&id=' + operationId;
