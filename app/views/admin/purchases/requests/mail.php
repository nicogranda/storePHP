                ...
                <td colspan='5' style='padding:0 0 0 15px;'>
                    <p style='font-size:16;'>
		                ...
		                Estimado(s) Señor(es)<br><br>
	 	                ...
	 	                Reciban un cordial saludo con la presente, a través de la cual solicitamos  precios sobre:
	 	            </p>
	 	        </td>
            </tr>    
...
<tr height='50px'>
    <td colspan='5' style='width:90%; height:55px; text-align:center;'>
        <a href='https://ikusa.net' style='color:#fff; text-decoration:none; background-color:#E10B76; display:inline-block; width:27%; padding:15px 0;'>
            Diseño Gráfico
        </a>
        <a href='https://ikusa.net' style='color:#fff; text-decoration:none; background-color:#10C3F3; display:inline-block; width:27%; padding:15px 0;'>
            Web Site
        </a>
        <a href='https://ikusa.net' style='color:#fff; text-decoration:none; background-color:#3ED53E; display:inline-block; width:27%; padding:15px 0;'>
            Marketing
        </a>
    </td>
</tr>
    	...
    	<tr align='center' height='30'>
    	    <td colspan='5' style='text-align:center; width:25%;padding:15px;'>
        		<a href='https://facebook.com/ikusa.creativestudio'><img src='https://ikusa.net/images/rrss/facebook.png' width='42px' height='auto'></a>
        		<a href='https://instragram.com/ikusa.creativestudio'><img src='https://ikusa.net/images/rrss/instagram.png' width='42px' height='auto'></a>
        	    <a href='https://linkedin.com/company/ikusacreativestudio/?viewAsMember=true'><img src='https://ikusa.net/images/rrss/linkedIn.png' width='42px' height='auto'></a>
        		<a href='https://api.whatsapp.com/send?phone=+14709837444'><img src='https://ikusa.net/images/rrss/youtube.png' width='42px' height='auto'></a>
            </td>
        </tr> 
