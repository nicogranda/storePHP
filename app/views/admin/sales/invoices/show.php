...
<section class="table-container">
    ...
    <tr>
        <th colspan="8" style="background-color:white; color:orangered; text-align:right; border: none;">
                <span style="color:gray; text-align:right;">Invoices:</span>
            <span style="color:orangered; text-align:right;"><?php echo $order['id']; ?></span><br>
            <span style="color:gray; text-align:right;">Quote:</span>
            <span style="color:orangered; text-align:right;"><?php echo $order['quote_id']; ?></span><br>
...
?>
    ...
    <input type="hidden" name="operation_id"  value="<?php echo  $order['id'];?>" id="operation_id" >
    <section class="events">   
       
        <input type="button" name="print" value="Print" onclick="downloadPDF()">
        <a href="index.php?page=invoices&action=mail&id=<?php echo $order['id']; ?>">Mail</a>
...
function downloadPDF() {
    // Capturamos el valor de budget_id y redirigimos al enlace con ese parámetro
     ...
     var url = 'https://ikusa.net/admin/index.php?page=invoices&action=print&id=' + operationId;
